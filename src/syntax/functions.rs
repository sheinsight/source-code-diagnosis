...
pub struct Functions<'a>{
        ...
        pub arguments_callee: Compat<'a>,
      
        pub arguments_length: Compat<'a>,
      
        pub arguments_iterator: Compat<'a>,
        ...
        pub default_parameters_destructured_parameter_with_default_value_assignment: Compat<'a>,
      
        pub default_parameters_parameters_without_defaults_after_default_parameters: Compat<'a>,
      
        pub functions_get: Compat<'a>,
      
        pub get_computed_property_names: Compat<'a>,
        ...
        pub rest_parameters_destructuring: Compat<'a>,
      
        pub functions_set: Compat<'a>,
      
        pub set_computed_property_names: Compat<'a>,
...
pub const FUNCTIONS: Functions = Functions { 
    ...
    default_parameters_destructured_parameter_with_default_value_assignment: Compat {
    ...
    default_parameters_parameters_without_defaults_after_default_parameters: Compat {
    ...
    get_computed_property_names: Compat {
    ...
    rest_parameters_destructuring: Compat {
      name: "destructuring",
    ...
    set_computed_property_names: Compat {
      name: "computed_property_names",
      description: r##"Computed property names"##,
      mdn_url: "undefined",
      spec_url: "undefined",
