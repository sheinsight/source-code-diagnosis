...
pub fn setup_method_definitions_async_generator_methods(v: &mut SyntaxVisitor) {
  v.walk_function.push(walk_function);
}

#[cfg(test)]
mod tests {
  use super::setup_method_definitions_async_generator_methods;
  use crate::assert_ok_count;

  assert_ok_count! {
    "async_generator_methods",
    setup_method_definitions_async_generator_methods,
