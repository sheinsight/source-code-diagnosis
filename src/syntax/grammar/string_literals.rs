...
pub struct StringLiteralsVisitor<'a> {
...
impl CommonTrait for StringLiteralsVisitor<'_> {
  fn get_cache(&self) -> Vec<CompatBox> {
    self.cache.clone()
  }
}

impl<'a> StringLiteralsVisitor<'a> {
...
impl<'a> Visit<'a> for StringLiteralsVisitor<'a> {
